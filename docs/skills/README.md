...
| [`/ce-user-test`](./ce-user-test.md) | Exploratory browser user testing on agent-browser by default, with opt-in watchable Chrome, 1-5 quality scoring, and compounding test files — companions `/ce-user-test-iterate`, `/ce-user-test-commit`, `/ce-user-test-eval` |
